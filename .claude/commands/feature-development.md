...
Read that file first using the Read tool and follow its phase order and skill requirements.
...
3. **Phase entry points and skills** (required — use the Skill tool to invoke each):
   - Phase 1 → **brainstorming** skill. If the feature adds a **new persistent entity** (tag, list, project, etc.), fill the **Entity/Resource CRUD checklist** in `docs/design-system/workflow.md` and reflect it in scope.
   ...
   - Phase 3–4 → **writing-plans** skill
   - Phase 5 → **executing-plans** skill (and when needed: **subagent-driven-development**, **test-driven-development**, **verification-before-completion**)
