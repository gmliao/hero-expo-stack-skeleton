    ...
    command: (() => {
      ...
      const extra =
        authHost || functionsUrl
          ...
          : ''
      return `dotenv -e .env -- sh -c 'cd apps/client && CI=1 EXPO_PUBLIC_USE_EMULATOR=true EXPO_PUBLIC_FIREBASE_PROJECT_ID=hero-stack-local EXPO_PUBLIC_FIREBASE_API_KEY=\${EXPO_PUBLIC_FIREBASE_API_KEY:-demo-api-key} EXPO_PUBLIC_FIREBASE_AUTH_DOMAIN=\${EXPO_PUBLIC_FIREBASE_AUTH_DOMAIN:-hero-stack-local.firebaseapp.com}${extra} bun run web -- --port 8099'`
    })(),
